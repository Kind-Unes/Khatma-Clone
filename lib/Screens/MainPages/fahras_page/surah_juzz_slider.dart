...
class QuranSliderX extends StatelessWidget {
  const QuranSliderX({super.key});
  @override
  Widget build(BuildContext context) {
    bool isVanish = Provider.of<PageVanishProvider>(context).vanish;
    PageController pageViewController = PageController(
        initialPage:
            Provider.of<QuranSliderProviderX>(context, listen: true).index);
    return Scaffold(
          ...
          : AppBar(
              ...
              actions: [
                ...
                Column(
                  ...
                  children: [
                    Text(
                      " سورة ${switchSurahName(Provider.of<QuranSliderProviderX>(context).index + 1)}",
                    ...
                    Text(
                      "${wird[Provider.of<QuranSliderProviderX>(context).index]} صفحة ${Provider.of<QuranSliderProviderX>(context).index + 1},جزء",
                      style: TextStyle(
                ...
                IconButton(
                    onPressed: () {
                      Provider.of<BookMarkProivder>(context, listen: false)
                          .index = Provider.of<QuranSliderProviderX>(context,
                              listen: false)
                          .index;
          ...
          child: Padding(
            ...
            child: Transform(
                ...
                child: Slider(
                  ...
                  value: Provider.of<QuranSliderProviderX>(
                    context,
                  ).index.toDouble(),
                  onChanged: (double newIndex) {
                    ...
                    pageViewController.jumpToPage(
                        Provider.of<QuranSliderProviderX>(context,
                                    listen: false)
                                .index +
                            1);
                  },
